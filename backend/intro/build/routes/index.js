...
route.get("/api", logger_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        res.status(200).send("hello world!");
    }
    catch (err) { }
}));
route.use("/api", logger_1.default, students_1.default);
route.use("/api", logger_1.default, teachers_1.default);
